  ...
  connectedCallback() {
    ...
    const isActive = (page) => {
      ...
      if (
        ...
        return true;
      if (
        currentBase.replace(/\.html$/, "") === pageBase.replace(/\.html$/, "")
      )
        return true;
      return false;
    };
    ...
    const isGroupPage =
      isActive("groups.html") ||
      isActive("groupCreate.html") ||
      isActive("groupAddTask.html") ||
      isActive("groupDetail.html") ||
      isActive("groupTasks.html");

    this.innerHTML = `
            <link rel="stylesheet" href="${styleUrl}" />
            <link rel="stylesheet" href="${darkUrl}" />
            <style>
                .nav-item {
                    position: relative;
                    display: flex;
            ...
            >
                <div class="flex justify-around items-center px-4 py-2" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <a href="main.html" class="nav-item ${
                      isActive("main.html") ? "active" : ""
                    }" 
                        style="color: ${
                          isActive("main.html") ? "#A40606" : "#230007"
                        };">
                    ...
                    <a href="addTask.html" class="nav-item ${
                      isActive("addTask.html") ? "active" : ""
                        ...
                        style="color: ${
                          isActive("addTask.html") ? "#A40606" : "#230007"
                        };">
                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" 
                    ...
                    <a href="viewTasks.html" class="nav-item ${
                      isActive("viewTasks.html") ? "active" : ""
                        ...
                        style="color: ${
                          isActive("viewTasks.html") ? "#A40606" : "#230007"
                        };">
                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" 
                            fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" />
                    ...
                    <a href="completedTask.html" class="nav-item ${
                      isActive("completedTask.html") ? "active" : ""
                        ...
                        style="color: ${
                          isActive("completedTask.html") ? "#A40606" : "#230007"
                        };">
                        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" 
                            fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" />
